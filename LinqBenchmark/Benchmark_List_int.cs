...
namespace LinqBenchmark
{
    ...
    public class Benchmark_List_int
    {
        ...
        struct SumFunc : IFunction<int, int>
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        internal static void QuickTest(int datasize, int iterations)
        {
            ...
            Benchmark_List_int test = new Benchmark_List_int();
            Benchmark_List_int.Lim = datasize;
            ...
            using (var timer = new CTimer("Test_linq_where_select()")) { for (int i = 0; i < iterations; ++i) test.Test_linq_where(); }
