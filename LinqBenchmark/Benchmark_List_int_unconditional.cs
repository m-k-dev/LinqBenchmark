...
namespace LinqBenchmark
{
    ...
    public class Benchmark_List_int_unconditional
    {
        ...
        {
            Console.WriteLine($"Benchmark_List_int_unconditional quick test (datasize {datasize}, {iterations} iterations)");
            Console.WriteLine();

            Benchmark_List_int_unconditional test = new Benchmark_List_int_unconditional();
            Benchmark_List_int_unconditional.Lim = datasize;
